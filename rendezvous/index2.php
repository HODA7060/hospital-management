...
<body>
   ...
   <div class="container">
       <div class="main-text">
           <h2>Nous avons les meilleures options de régime d'assurance-maladie pour vous</h2>
           <button><a href="adminlog.php">admin</a></button>
       </div>
   </div>
<!-- services we provide -->
...
<!-- our gallery -->
<div class="gallery">
    <h2 class="galleryheading"><span>our</span> Gallery</h2>
...
<div class="ourteam-section">
    ...
    <div class="ourteam-inner">
        <div class="section-box">
            <img src="images/ourteam1.png" alt="">
            <h3>Dr.Ahmed</h3>
        ...
        <div class="section-box">
            <img src="images/ourteam2.png" alt="">
            <h3>Dr:sahir</h3>
            <p>assistant surgeon</p>
            <div class="team-social-links">
                <i class="fab fa-linkedin"></i>
        ...
        <div class="section-box">
            <img src="images/ourteam4.png" alt="">
            <h3>Dr.daoud</h3>
            <p>assistant surgeon</p>
            <div class="team-social-links">
                <i class="fab fa-linkedin"></i>
